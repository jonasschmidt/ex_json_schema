defmodule ExJsonSchema.Validator.Format do
  ...
  defp do_validate("idn-hostname", data) do
    validate_with_regex(data, @idn_hostname_regex, fn data -> "Expected #{inspect(data)} to be an idn email." end)
  end

  defp do_validate("idn-email", data) do
    validate_with_regex(data, @idn_email_regex, fn data -> "Expected #{inspect(data)} to be an idn email." end)
  end
  ...
  defp do_validate("iri-reference", data) do
    validate_with_regex(data, @iri_reference_regex, fn data -> "Expected #{inspect(data)} to be an iri." end)
  end
